...
public class library {
    ...
    public static void borrowerdetail() {
        ...
        sc.nextLine();
        switch (a) {
            case 1 : currentBorrower();
            case 2 : returnBorrower();
            case 3 : admin();
            default : {
                System.out.println("Enter Number Between 1 & 3");
                Enter();
    ...
    public static void currentBorrower() {
        Flush();
    ...
    public static void userviewbook() {
        Flush();
        if (Bookdetaillist.size() <= 0) {
            System.out.println("- No Books Available In the Library -");
            Enter();
